...
While one iteration of differential corrections is often sufficient to accurately refine the result, the initial estimate required multiple iterations to compensate for the asteroid's position in its orbit.
...
This research demonstrates the possibility of computing orbits and furnishing excellent orbital parameters even in adverse situations.
