...
The asteroid 1951 Lick was observed on seven days using a 14'' Meade telescope and the 24'' Keck Telescope at Westmont College in order to engage an orbit determination process through which the orbital elements eccentricity, semimajor axis, inclination, longitude of the ascending node, and argument of periapsis were determined.  Through these, the accuracy of established ephemeris generators such as NASA's Jet Propulsion Laboratory Horizons database could be evaluated due to their lack of current observations.  From seventeen usable images, the right ascension and declination of the asteroid was measured using least-squares plate reductions on the surrounding stars, whose right ascension and declination were known.  By first using the Gaussian method of orbit determination and then Laplace's method of orbit determination including five iterations of differential corrections, the orbit of our asteroid was able to be computed.  At Julian date 2455237.7 JD, the apparent magnitude of our asteroid was deterrmined to be 16.991, the semimajor axis was 1.3894 AU, the eccentricity is 0.06053, the inclination is 39.089 degrees, the longitude of the ascending node was 130.7706 degrees, and the argument of periapsis was 140.65 degrees.  Relative to an observation made on July 19, the ephemeris calculated from our orbital elements was within 0.112s for right ascension and 1.56'' declination of the observed coordinates of the asteroid determined using least-squares plate reductions.  
